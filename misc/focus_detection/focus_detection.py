"""
focus_detection.py - Tenengrad focus detection and single-frame visualisation.

Core pipeline
-------------
  generate_focus_map    -- compute a per-pixel focus score map from a BGR/gray image
